...
The image is currently shipping with the Open Data Hub version of Llama Stack version [0.3.4+rhai0](https://github.com/opendatahub-io/llama-stack/releases/tag/v0.3.4+rhai0)
